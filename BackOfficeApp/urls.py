...
from .views import add_customer_product, delete_customer_product, update_customer_product, get_all_customers_products, update_product_category, delete_product_category, get_product_categories, add_product_category, get_customers, add_customer, update_customer_personal_details, delete_customer, add_account_product, update_account_product

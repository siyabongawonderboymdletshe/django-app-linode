...
def add_product_category(request):
    ...
    return render (request, 'AdminDashboard/category/add_product_category.html', {'dashboard_session': dashboard_session_context})
def update_product_category(request, category_id):
    ...
    if not category:
        ...
        dashboard_session_context.add_product_category = productCategoryForm
        dashboard_session_context.product_category_id = category_id
        return render (request, 'AdminDashboard/category/update_product_category.html', {'dashboard_session': dashboard_session_context})
